...
export const MacbookScroll = ({
  ...
  // Improved animations with springs for smoother motion
  ...
  const translate = useTransform(smoothProgress, [0, 1], [0, 1200]);
  ...
  const reflectionOpacity = useTransform(smoothProgress, [0, 0.2, 0.3, 0.5], [0.1, 0.3, 0.5, 0]);

  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center py-0 md:py-40 justify-start shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >
      {title && (
        <motion.div
          style={{
        ...
        >
          <h3 className="text-xl font-medium text-gray-900 dark:text-gray-100 text-center">
            {title}
          </h3>
        </motion.div>
      )}
      ...
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] bg-[#151515] dark:bg-[#111111] rounded-lg overflow-hidden relative -z-10 shadow-xl">
        {/* above keyboard bar */}
        <div className="h-10 w-full relative">
          <div className="absolute inset-x-0 mx-auto w-[80%] h-4 bg-[#0a0a0a]" />
        </div>
        ...
        <Trackpad />
        <div className="h-2 w-20 mx-auto inset-x-0 absolute bottom-0 bg-gradient-to-t from-[#151515] to-[#0a0a0a] rounded-t-lg" />
        {showGradient && (
          <div className="h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t dark:from-black from-[#151515] to-transparent z-50"></div>
        )}
...
export const Lid = ({
  ...
  src?: string;
  reflectionOpacity: MotionValue<number>;
}) => {
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[32rem] bg-[#050505] rounded-lg p-1 relative shadow-lg"
      >
        <div
          style={{
            boxShadow: "0px 2px 0px 2px var(--neutral-900) inset",
          }}
          className="absolute inset-0 bg-[#0a0a0a] rounded-lg flex items-center justify-center"
        >
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-[#050505] rounded-lg p-1 shadow-xl"
      >
        <div className="absolute inset-0 bg-[#0a0a0a] rounded-lg overflow-hidden">
          ...
          <Image
            ...
            fill
            priority
            className="object-cover absolute rounded-md inset-0 h-full w-full"
          />
...
export const Trackpad = () => {
  return (
    <div
      className="w-[40%] mx-auto h-32 rounded-lg my-1 bg-[#111]/80 backdrop-blur-sm"
      style={{
        boxShadow: "0px 0px 1px 1px rgba(255,255,255,0.05) inset, 0 0 30px rgba(0,0,0,0.15) inset",
      }}
    >
      {/* Subtle trackpad highlight */}
      <div className="h-full w-full opacity-10 bg-gradient-to-br from-white/5 via-transparent to-transparent" />
    </div>
  );
};
